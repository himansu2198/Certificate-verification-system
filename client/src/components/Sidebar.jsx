    ...
    <aside className="fixed top-0 left-0 h-full w-64 bg-slate-900 flex flex-col z-40 shadow-2xl">
      ...
      <div className="px-6 py-6 border-b border-slate-800">
        <Link to="/" className="flex items-center gap-2">
          ...
          <span className="text-white font-bold text-lg">CertiVerify</span>
        </Link>
      </div>

      {/* Nav */}
      <nav className="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
        <p className="text-slate-500 text-xs font-semibold uppercase tracking-widest px-3 mb-4">Menu</p>
        {navItems.map((item) => {
